        ...
        {showProfile && 
            <div className='fixed top-0 left-0 bg-black/60 w-full h-full'>
                <div className='flex justify-center items-center h-full'>
                    <div className='bg-white flex flex-col items-center justify-evenly relative w-[80%] h-[250px] sm:w-[50%] sm:h-[350px] md:w-1/3 lg:h-[400px] 2xl:h-[500px] rounded-md opacity-1'>
